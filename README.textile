...
p. The @RuleEngines@ utility class offers to build 3 different rule engines:

* *chained* All rules will be evaluated indefinitely until no further rule fires.
* *limited* All rules will be evaluated, but only a maximum number of _x_ times.
* *firstWins* Evaluates all rules, stops after the first one that fires.
