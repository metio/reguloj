...
p. This project supplies a simple implementation for the @RuleEngine@ interface, called @SimpleRuleEngine@, which supports rule chaining and a simple implementation of the @Context@ interface called @SimpleContext@.
